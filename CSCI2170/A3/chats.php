...
<head>
	<title>
        <?php
            if ($userId==1)//change title name,if it is account user,it is MyChat, otherwise, it is Chat
                echo "MyChat";
            else
                echo "Chat";
        ?>
	  	...
	  	<div class="collapse navbar-collapse" id="navbarNav" >  
		    <ul class="nav nav-pills mr-auto">
		      <li class="nav-item"><a class="nav-link" href="./index.php" style="color: white;font-size: 1em;">Home</a></li>
                <?php
                    if ($userId==1)//if the user id is the account user, the MyChat in the nav bar should be shown as selected
                    {
                        echo <<<nav
						...
						<div class="media">
							<div class="media-body">
								<div class="container" style="margin-top:20px;margin-bottom: 20px;">
                                    ...
                                    <!--3 links starts here-->
                                    <?php
                                        $number=padNum($userId);//profile counters
                                        echo <<<count
                                        <div class="media">
                                            <div class="media-body">
						...
						<div class="container-fluid" style="margin-top:10px;margin-bottom: 0px; ">
							...
							<!--Start of list of chats-->					
								<div class="list-group" style="background-color: #E8F8FF; ">
									<h2><?php
                                            if ($userId==1)//change heading according to the userId
                                                echo "My Chats";
                                            else

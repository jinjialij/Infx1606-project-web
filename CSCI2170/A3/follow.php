...
<?php
    ...
    {
        $followList =getAllFollowingName($userId);//get followings' name according to the account user
    }
    else if($pageName=='Followers')
    {
        $followList= getAllFollowerName($userId);//get followers' name according to the account user
    }
    else
    {
    ...
    if (isset($_POST['newChat']))//if create a new chat
    {
        ...
        {
            myNewChats($chatContent);//call the function to write chat to database
        }
    ...
    if (isset($_POST['chatContent']))//if create a new chat by chat button
    {
        ...
        if ($chatContent!=null)//write to database only if content is not empty
            $newChatFeedback=myNewChats($chatContent);//call the function to write chat to the database
    }
                        ...
                        <div class="media" style="background-color: #91C9E8;padding-top: 20px;padding-bottom: 10px;min-width: 128px;">
                            <div class="container-fluid">
                                ...
                                <div class="media" >
                                    <div class="media-body">
                                        <?php
                                        if ($userId!=1)//change the user's account head img, default is an owl which represents my head
                                        {
                        ...
                        <div class="media">
                            <div class="media-body">
                                <div class="container" style="padding-left: 0px;padding-right: 0px;">
                                    <?php
                                        $number=padNum($userId);//a function counts the number of chats, followings, followers
                                        echo <<<count
                                        <div class="media">
                                            <div class="media-body">
                                                <div class="container" style="padding-left: 0px;padding-right: 0px;">

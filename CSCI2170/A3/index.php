...
<?php
    ...
    if (isset($_POST['newChat']))//if create a new chat using the pad
    {
        ...
        {
            $newChatFeedback=myNewChats($chatContent);//call the function to write chat to the file
        }
    ...
    $followingChats=loadMyFollowingChats();//all chats from whom I am following
?>
	<!--Start of nav-->
                                ...
                                <div class="media" style="background-color: white;padding-left: 10px;padding-bottom: 28px;padding-right: 45px;padding-top: 38px;">
                                  ...
                                  <div class="media-body" style="padding-left: 15px;">
                                    ...
                                    <small class="text-muted">
                                        <p class="card-text" style="display: inline-flex;"><!--time-->$v1[2]</p>
                                    </small>

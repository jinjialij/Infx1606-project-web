...
<div class="container-fluid" style="margin-bottom: 20px;">
    <form method="post" action="./findPeople.php" name="form1">
        <div class="row justify-content-md-center text-center" style="">
            <p style="color: #005BA8;font-size: 2em;font-weight: bold;margin-bottom: 3%;">Welcome username! Please fill in you profile information</p>
        </div>
        <div class="form-group row col-sm-10">
            <label for="firstName" class="col-sm-2 col-form-label" style="color: #005BA8;font-weight: bold;font-size: 1.5em; text-align: left;">First name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="fn" style="border-color: #005BA8;border-width: 1px;" required name="fn">
            </div>
        </div>
        <div class="form-group row col-sm-10">
            <label for="lastName" class="col-sm-2 col-form-label" style="color: #005BA8;font-weight: bold;font-size: 1.5em;text-align: left;">Last name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="ln" style="border-color: #005BA8;border-width: 1px;" required name="ln">
            </div>
        </div>
        <div class="form-group row col-sm-10">
            <label for="profile" class="col-sm-2 col-form-label" style="color: #005BA8;font-weight: bold;font-size: 1.5em;text-align: left;" >Tells us about you: </label>
            <div class="col-sm-10">
                <textarea type="text" class="form-control" id="profileContent" rows="10" style="border-color: #005BA8;border-width: 1px;" required name="profile"></textarea>
            </div>
        </div>
        <div class="row" style="">
            ...
            <!--Next button-->
            <div class="col-sm-2">
                <button class="btn btn-primary btn-lg "  type="submit" name="next" value="submit"  >Next</button>
            </div>
        </div>
    </form>
</div>

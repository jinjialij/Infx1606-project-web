						...
						<div class="container" style="margin-top:10px;margin-bottom: 0px; ">
                            ...
                            <div class="row" style="padding: 5px;"  >
                                <form class="form-inline" style="width: 100%;" method="get">
                                    ...
                                    <input class="form-control" type="text" placeholder="Chit Chat..." style="height:40px;width: 90%;" name="newChat" value="" required size="200">
                                </div>
                                </form>
                            </div>
                            <!--End of chat pad-->
							...
							<div class="container">
								<div class="list-group" style="background-color: #E8F8FF;">
									...
									<!--Start of Name 1-->
									  ...
									  <div class="media-body">
									    <h3 class="mt-0">
                                            <a href="./chats.php?name=<?php
                                                if($pageName=='Following')
                                                    echo "$followingList[0]";
                                                else if($pageName=='Followers')
                                                    echo "$followerList[0]";
                                            ?>">
                                                <?php

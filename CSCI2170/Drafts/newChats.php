...
<?php
    ...
    $dateTime=array();
    $text=array();
    $followingChats=loadUserChats();//all following chats
    for ($row=0;$row<count($followingChats);$row++)
    {
        $name[$row]=$threeChats[$row][0];
        $dateTime[$row]= $threeChats[$row][1];
        $text[$row]= $threeChats[$row][2];
    }
			...
			<div class="container-fluid" style="margin-bottom: 20px;">
				<div class="row mb-2">	
					...
					<div class="col-sm" style="background-color: #E8F8FF;margin-top:10px;padding-bottom: 10px;">		
										  	...
										  	<div class="col-sm-10">
										  		<div class="row" style="margin-left: 10px;">
										  			...
										  			<small class="text-muted">
											    		<p class="card-text" id="user1" style="display: inline-flex;"><!--time-->
                                                            <?php
                                                                echo "$dateTime[0]";
                                                            ?>
                                                        </p>
											    	...
											    	<div class="col-sm-10">
									    				<p class="card-text" id="chat1"><!--text-->
                                                            <?php
                                                                echo "$text[0]";
                                                            ?>
                                                        </p>
								      ...
								      <div class="col-sm-10">
								        <div class="row">
								          ...
								          <div class="col-sm-10">
								            ...
								            <!--chat content-->
								            	<small class="text-muted">
										    		<p class="card-text" id="user2" style="display: inline-flex;"><!--time-->
                                                        <?php
                                                            echo "$dateTime[1]";
                                                        ?>
                                                    </p>
												  	...
												  	<div class="col-sm-10">
												  		<div class="row">							  			
												  			<div class="col-sm-10"><!--Name and post time -->
													    		...
													    		<small class="text-muted">
														    		<p class="card-text" id="user3" style="display: inline-flex;"><!--time-->
                                                                        <?php
                                                                            echo "$dateTime[2]";
                                                                        ?>
                                                                    </p>
                        ...
                        <a name="more" href="./newChats.php" >More</a>
